...
print RESULTENTITIES #list of list of tuples (entity,value) over query set's result' returned by WIT
print "YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY\n"
print ENTITIES #list of list of tuples (entity,value) over intial query set as input manually in query.txtfile'